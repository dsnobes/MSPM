classdef Simulation < handle
    ...
    methods
        ...
        function [Results, success, cycle_count, final_speed, final_power] = Run(ME, islast, do_warmup, ss_tolerance, options)
            ...
            [Plot_Powers, Plot_Speed, fig, ME, Results, n] = Main_Simulation_loop(ME, simTime, n, Results, grab_Pressure, grab_Temperature, grab_Velocity, grab_PressureDrop, grab_Turbulence, grab_ConductionFlux, grab_Reynolds, previousTime, AdjustTime, sindn, ss_tolerance, options, ss_cycles, indf, Load_Function_is_Not_Given, engine_Pressure, LEN);
...
function [Plot_Powers, Plot_Speed, fig, ME, Results, n] = Main_Simulation_loop(ME, simTime, n, Results, grab_Pressure, grab_Temperature, grab_Velocity, grab_PressureDrop, grab_Turbulence, grab_ConductionFlux, grab_Reynolds, previousTime, AdjustTime, sindn, ss_tolerance, options, ss_cycles, indf, Load_Function_is_Not_Given, engine_Pressure, LEN)
    ME.curTime = 0;
    ME.CycledE = 0;
    cycle_count = 0;
    MechCycleEnergy = 0;
