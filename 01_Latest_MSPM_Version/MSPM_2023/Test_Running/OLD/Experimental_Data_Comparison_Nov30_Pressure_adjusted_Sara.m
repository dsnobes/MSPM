function [RunConditions] = Experimental_Data_Comparison_Nov30_Pressure_adjusted_Sara()
...
%% Input Parameters
exp_filename = '2019_04_12_RD.mat'; % Name of experimental data file.
model = 'Raphael_26Nov2021_from05NovVersion_Sensors_CrankMotion_MatchingSara'; % Name of MSPM model geometry.
...
for i = 1:size(RD_DATA,2)
    ...
    RunConditions(i).title = ['P_adjusted_Material_Crank' RD_DATA(i).filename];
end
