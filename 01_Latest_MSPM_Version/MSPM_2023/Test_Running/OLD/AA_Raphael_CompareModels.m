function [RunConditions] = AA_Raphael_CompareModels()
...
model = {'Raphael_2022-05-04_FinEnhSurf_Reg97_oldHX_compare', 'Raphael_2022-05-04_FinEnhSurf_Reg97_newHX_compare'}; % Name of MSPM model geometry.
pmean = (100:100:500) *1000;
speed = (100:50:250); % [rpm]
...
for i = 1:length(model)
    for p = pmean
        for s = speed
            ...
            RunConditions(n).title = [model{i} '_p' num2str(p/1000) '_rpm' num2str(s)];
        n = n+1;
        end
    end
end
