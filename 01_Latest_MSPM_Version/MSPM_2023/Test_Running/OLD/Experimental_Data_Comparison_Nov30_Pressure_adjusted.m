function [RunConditions] = Experimental_Data_Comparison_Nov30_Pressure_adjusted()
...
%% Input Parameters
exp_filename = 'G:\Shared drives\NOBES_GROUP\MSPM\[MATLAB_WORKING_FOLDER]\Data Processing Code\06_Post Processing_Experimental\[Experimental Data]\2021-12-16 p200\2021-12-16 p200_T0-1.04\2021-12-16 p200_T0-1.04_RD.mat'; % Name of experimental data file.
...
p_environment = 94000; % https://edmonton.weatherstats.ca/charts/pressure_station-daily.html
...
for i = 1:size(RD_DATA,2)
    ...
    RunConditions(i).title = ['P_adjusted_' RD_DATA(i).filename];
end
