function [RunConditions] = Raphael_Radial_Scaling_Type_1()
% Scaling test set for Raphael

%% Input Parameters
% Name of experimental data files.
model = {
    'Scaling - Radial - Type 1 - Scale 1 - New H',...
    'Scaling - Radial - Type 1 - Scale 2 - New H',...
    'Scaling - Radial - Type 1 - Scale 5 - New H',...
    'Scaling - Radial - Type 1 - Scale 10 - New H',...
