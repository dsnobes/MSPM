...
model = {
    'Scaling - Radial - Type 1 - Scale 1',...
    'Scaling - Radial - Type 1 - Scale 2',...
    'Scaling - Radial - Type 1 - Scale 5',...
    'Scaling - Radial - Type 1 - Scale 10',...
    'Scaling - Radial - Type 2 - Scale 1',...
    'Scaling - Radial - Type 2 - Scale 2',...
    'Scaling - Radial - Type 2 - Scale 5',...
    'Scaling - Radial - Type 2 - Scale 10',...
