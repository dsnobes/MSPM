function [RunConditions] = Raphael_Helium_Testing_High_Speed()
...
model = {
    ...
    'Raphael New HX - Helium 90',...
    'Raphael New HX - Helium 85',...
    'Raphael New HX - Helium 80',...
    'Raphael Old HX - Air',...
    'Raphael Old HX - Helium 100',...
    'Raphael Old HX - Helium 99',...
    'Raphael Old HX - Helium 95',...
    'Raphael Old HX - Helium 90',...
    'Raphael Old HX - Helium 85',...
    'Raphael Old HX - Helium 80',...
    }; % Name of MSPM model geometry.

pressures = [300, 435, 570] .*1000; % [Pa]
speeds = [275 310 345 380 415 450 485 520]; % [rpm]
