...
model = {
    'Scaling - Type 1 - Scale 1',...
    'Scaling - Type 1 - Scale 2',...
    'Scaling - Type 1 - Scale 5',...
    'Scaling - Type 1 - Scale 10',...
    'Scaling - Type 2 - Scale 1',...
    'Scaling - Type 2 - Scale 2',...
    'Scaling - Type 2 - Scale 5',...
    'Scaling - Type 2 - Scale 10',...
