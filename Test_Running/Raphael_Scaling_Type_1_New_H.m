function [RunConditions] = Raphael_Scaling_Type_1_New_H()
% Scaling test set for Raphael

%% Input Parameters
% Name of experimental data files.
model = {
    'Raphael New HX - Type 1 - Scale 1 - New H',...
    'Raphael New HX - Type 1 - Scale 2 - New H',...
    'Raphael New HX - Type 1 - Scale 5 - New H',...
    'Raphael New HX - Type 1 - Scale 10 - New H',...
